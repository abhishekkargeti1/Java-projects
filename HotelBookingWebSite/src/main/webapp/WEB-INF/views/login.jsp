...
<head>
    ...
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.0.0-beta3/css/all.min.css" integrity="sha384-k6RqeWeci5ZR/Lv4MR0sA0FfDOMlD0dvn79zfrA7LKbBq5O4fbZmL3DmRXaMy7xM" crossorigin="anonymous">
    ...
    <div class="container d-flex align-items-center justify-content-center vh-100">
        <div class="login-card">
            ...
            <div class="text-center footer-link">
                ...
                &nbsp;
                <a href="SignUp_Page">Sign Up Here</a>
            </div>
            <div class="text-center social-buttons">
                <p>Or login with</p>
                <a href="#" class="btn btn-outline-primary btn-sm"><span><i class="fa fa-facebook" aria-hidden="true"></i>
                </span></a>
                <a href="#" class="btn btn-outline-danger btn-sm"><span><i class="fa fa-google" aria-hidden="true"></i>
                </span></a>
            </div>
        </div>
    </div>
